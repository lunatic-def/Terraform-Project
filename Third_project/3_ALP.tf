...
resource "aws_lb_target_group_attachment" "mytg1" {
  for_each = {for k, v in module.private-instances: k => v} # for each privates instance 
...
output "zz_ec2_private" {
  ...
  value = {for ec2_instance, ec2_instance_details in module.private-instances: ec2_instance => ec2_instance_details}
}